jQuery( function($) {
	...
	//_____________ SignIn Popup ___________
	var popupStatus = 0;
	...
	//_____________ end SignIn Popup ___________

	//_____________ Register Popup ___________
	$("#Register_PopUp_Link").click(function() {
		...
		// Aligning bg
		$("#RegisterBackgroundPopup").css({"height": windowHeight});
	
		// Pop up the div and Bg
		if (popupStatus == 0) {
			$("#RegisterBackgroundPopup").css({"opacity": "0.7"});
			$("#RegisterBackgroundPopup").fadeIn("slow");
			$("#popupRegister").addClass('zigmaIn').fadeIn("slow");
			popupStatus = 1;
		}
	});
	// Close Popup
	$("#popupRegisterClose").click(function() {
		if (popupStatus == 1) {
			$("#RegisterBackgroundPopup").fadeOut("slow");
			$("#popupRegister").removeClass('zigmaIn').fadeOut("slow");
			popupStatus = 0;
		}
	});
	$("body").click(function() {
	...
	$('#popupRegister, #Register_PopUp_Link').click(function(e) {
		e.stopPropagation();
	});
	
	//_____________ end Register Popup ___________
